...
function getChairByID(Id){
    var chairId = Id.body.chairId
    var db = new sqlite3.Database(dbPath,(err,data)=>{
      let ans={stat:"",content:""}
        if(!err){
...
// edit chair quantity
function editChairQuantity(inputJson){
  var chairId = inputJson.body.chairId
  var changeNum=inputJson.body.changeNumber
...
//edit table quantity
function editTableQuantity(inputJson){
  var tableId = inputJson.body.tableId
  var changeNum=inputJson.body.changeNumber
...
function getSingleSofaInfoById(inputJson){
    var sofaId = inputJson.body.sofaId
    var db = new sqlite3.Database(dbPath,(err,data)=>{
      let ans={stat:"",content:""}
        if(!err){
...
// edit sofa quantity
function editSofaQuantity(inputJson){
  var sofaId = inputJson.body.sofaId
  var changeNum=inputJson.body.changeNumber
...
function getSingleBedInfoById(inputJson){
    var bedId = inputJson.body.bedId
    var db = new sqlite3.Database(dbPath,(err,data)=>{
      let ans={stat:"",content:""}
        if(!err){
...
// edit bed quantity
function editBedQuantity(inputJson){
  var bedId = inputJson.body.bedId
  var changeNum=inputJson.body.changeNumber
...
function getOrderInfoById(inputJson){
    var orderId = inputJson.body.orderId
    var db = new sqlite3.Database(dbPath,(err,data)=>{
      let ans={stat:"",content:""}
        if(!err){
